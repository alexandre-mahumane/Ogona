      ...
      <View className="gap-6 px-6 pt-6">
        ...
        <View className="flex-row gap-2">
          {[
            ...
            <View
              key={s.l}
              className="flex-1 items-center rounded-[15px] bg-surface-muted p-3"
            >
              <Text className="font-inter-semibold text-[15px] text-ink">
                {s.v}
              </Text>
              <Text className="font-inter text-[10px] text-ink-soft">{s.l}</Text>
            </View>
          ))}
        </View>
        ...
        <View className="gap-2">
          ...
          <Pressable
            ...
            className="h-9 items-center justify-center rounded-[15px] border border-surface-border bg-surface"
          >
